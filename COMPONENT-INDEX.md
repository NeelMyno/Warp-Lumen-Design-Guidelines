...
> **Auto-generated for Lumen v0.13.2** (2026-05-19). Run `node scripts/build-component-index.mjs` to regenerate. Source of truth: the `design-system/02-components/*/component.json` files. **Never hand-edit this file** — drift is caught by the next regeneration.
...
```bash
pnpm dlx shadcn@latest add <cdn>/lumen/v0.13.2/registry/{name}.json
```
...
Generated 2026-05-19 from VERSION = 0.13.2.
