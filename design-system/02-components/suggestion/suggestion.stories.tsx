...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Suggestion from Vercel AI Elements (Lumen-themed). Install: `npx ai-elements@latest add suggestion`. Canonical name; supersedes `suggestion-strip`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Suggestion — install via <code>npx ai-elements@latest add suggestion</code> then uncomment the import above.
    </div>
  ),
};
