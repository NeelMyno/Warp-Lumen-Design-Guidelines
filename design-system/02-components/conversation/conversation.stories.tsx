...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Conversation from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add conversation\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Conversation — install via <code>npx ai-elements@latest add conversation</code> then uncomment the import above.
    </div>
  ),
};
