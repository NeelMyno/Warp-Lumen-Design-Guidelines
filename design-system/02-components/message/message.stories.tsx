...
const meta = defineMeta({
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Message from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add message\`.",
      },
    },
  },
...
export const Default = meta.story({
  render: () => (
    ...
    >
      Message — install via <code>npx ai-elements@latest add message</code> then uncomment the import above.
    </div>
  ),
});
