...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Artifact from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add artifact\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Artifact — install via <code>npx ai-elements@latest add artifact</code> then uncomment the import above.
    </div>
  ),
};
