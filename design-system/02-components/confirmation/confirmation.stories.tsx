...
const meta = defineMeta({
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Confirmation from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add confirmation\`.",
      },
    },
  },
...
export const Default = meta.story({
  render: () => (
    ...
    >
      Confirmation — install via <code>npx ai-elements@latest add confirmation</code> then uncomment the import above.
    </div>
  ),
});
