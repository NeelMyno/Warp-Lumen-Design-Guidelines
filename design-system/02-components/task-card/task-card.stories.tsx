...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Task from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add task\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Task — install via <code>npx ai-elements@latest add task</code> then uncomment the import above.
    </div>
  ),
};
