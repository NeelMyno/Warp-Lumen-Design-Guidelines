 ...
 *
 * Lumen ships the contract (this file + ./suggestion-strip.md + ./suggestion-strip.skill.md).
 ...
 * <LumenAIProvider>. See:
 *   - ./suggestion-strip.md for the API contract
 *   - ./suggestion-strip.skill.md for NEVER rules
 ...
 * `npx shadcn add @lumen/suggestion-strip` get this file copied to
