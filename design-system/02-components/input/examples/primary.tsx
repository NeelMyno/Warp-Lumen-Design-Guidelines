  ...
  return (
    <input
      ...
      className={[
        ...
        "shadow-[var(--input-ring-lit-edge)]",
        ...
        "disabled:cursor-not-allowed disabled:bg-[var(--input-background-disabled)] disabled:text-[var(--input-foreground-value-disabled)] disabled:border-[var(--input-border-disabled)] disabled:pointer-events-none",
        "read-only:cursor-default read-only:bg-[var(--input-background-read-only)] read-only:text-[var(--input-foreground-value-read-only)] read-only:border-[var(--input-border-read-only)]",
        SIZE[size],
