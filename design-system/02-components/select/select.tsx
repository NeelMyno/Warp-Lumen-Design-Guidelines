...
/**
 * @lumen/select — v0.13 Phase 2 canonical implementation.
 * ----------------------------------------------------------------------------
 * Built on Radix Select. v0.6 field-shell trigger. Portaled content.
 */
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-[var(--radius-md)] border border-[var(--border-default)] bg-[var(--surface-input-rest)] px-3 py-2 text-[length:var(--type-14)] text-[color:var(--text-primary)] whitespace-nowrap outline-none",
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-[var(--border-hairline)] pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
