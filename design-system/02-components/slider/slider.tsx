...
/**
 * @lumen/slider — v0.13 Phase 2 canonical implementation.
 * ----------------------------------------------------------------------------
 * Built on Radix Slider. Single or range — pass defaultValue.length thumbs.
 * Position math via Radix's inline styles (per hard rule 12).
 */
