...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "JSXPreview from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add jsx-preview\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      JSXPreview — install via <code>npx ai-elements@latest add jsx-preview</code> then uncomment the import above.
    </div>
  ),
};
