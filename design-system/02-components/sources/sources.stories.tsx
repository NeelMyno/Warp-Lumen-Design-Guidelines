...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Sources from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add sources\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Sources — install via <code>npx ai-elements@latest add sources</code> then uncomment the import above.
    </div>
  ),
};
