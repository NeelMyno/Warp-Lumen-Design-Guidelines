...
const meta = defineMeta({
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "WebPreview from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add web-preview\`.",
      },
    },
  },
...
export const Default = meta.story({
  render: () => (
    ...
    >
      WebPreview — install via <code>npx ai-elements@latest add web-preview</code> then uncomment the import above.
    </div>
  ),
});
