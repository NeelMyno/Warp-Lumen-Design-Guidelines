...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "MessageResponse from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add message\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      MessageResponse — install via <code>npx ai-elements@latest add message</code> then uncomment the import above.
    </div>
  ),
};
