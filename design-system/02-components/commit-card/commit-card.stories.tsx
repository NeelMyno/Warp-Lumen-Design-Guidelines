...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Commit from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add commit\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Commit — install via <code>npx ai-elements@latest add commit</code> then uncomment the import above.
    </div>
  ),
};
