...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Six-state agent lifecycle indicator. Install: `npx ai-elements@latest add agent`. Canonical name; supersedes `agent-state`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      Agent — install via <code>npx ai-elements@latest add agent</code> then uncomment the import above.
    </div>
  ),
};
