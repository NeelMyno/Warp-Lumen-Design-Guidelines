...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "SchemaDisplay from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add schema-display\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      SchemaDisplay — install via <code>npx ai-elements@latest add schema-display</code> then uncomment the import above.
    </div>
  ),
};
