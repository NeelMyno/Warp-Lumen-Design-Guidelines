 ...
 *
 * Lumen ships the contract (this file + ./loader-ai.md + ./loader-ai.skill.md).
 ...
 * <LumenAIProvider>. See:
 *   - ./loader-ai.md for the API contract
 *   - ./loader-ai.skill.md for NEVER rules
 ...
 * `npx shadcn add @lumen/loader-ai` get this file copied to
