...
const meta = defineMeta({
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "StackTrace from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add stack-trace\`.",
      },
    },
  },
...
export const Default = meta.story({
  render: () => (
    ...
    >
      StackTrace — install via <code>npx ai-elements@latest add stack-trace</code> then uncomment the import above.
    </div>
  ),
});
