...
const meta = defineMeta({
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Actions from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add actions\`.",
      },
    },
  },
...
export const Default = meta.story({
  render: () => (
    ...
    >
      Actions — install via <code>npx ai-elements@latest add actions</code> then uncomment the import above.
    </div>
  ),
});
