...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Canvas from Vercel AI Elements (Lumen-themed). Install: \`npx ai-elements@latest add canvas\`.",
      },
    },
  },
...
export const Default: Story = {
  render: () => (
    ...
    >
      WorkflowCanvas — install via <code>npx ai-elements@latest add canvas</code> then uncomment the import above.
    </div>
  ),
};
