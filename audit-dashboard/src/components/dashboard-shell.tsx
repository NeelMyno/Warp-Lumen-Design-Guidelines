  ...
  return (
    <div className="min-h-svh flex flex-col relative">
        ...
        <div className="lumen-glass border-b border-[var(--border-hairline)]">
          <div className="mx-auto flex w-full max-w-[1440px] items-center gap-4 px-6 h-16">
            ...
            >
              ...
              <span className="hidden sm:inline-flex items-center h-5 px-2 rounded-[var(--radius-full)] text-[var(--type-11)] font-medium border border-[var(--border-accent)] text-[var(--text-accent)] tracking-[var(--tracking-wide)]">
                v0.4
              </span>
            </Link>
            ...
            <button
              className="hidden md:flex items-center gap-2 flex-1 max-w-md mx-auto h-10 px-4 rounded-[var(--radius-full)] border border-[var(--border-subtle)] bg-[var(--surface-raised)]/60 text-[var(--text-tertiary)] text-[var(--type-13)] hover:border-[var(--border-default)] hover:text-[var(--text-secondary)] transition-colors"
      ...
      <footer className="mt-16 border-t border-[var(--border-hairline)] bg-[var(--surface-canvas)]">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-6 py-10 text-[var(--type-12)] text-[var(--text-tertiary)]">
          <div className="flex items-center gap-3">
            <LumenMark size={14} />
          ...
          <div className="flex items-center gap-4 lumen-mono-cap">
            <span>v0.4.0 · audit preview</span>
