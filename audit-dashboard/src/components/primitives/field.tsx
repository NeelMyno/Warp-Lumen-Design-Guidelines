...
/**
 * Composed text input with label, helper, error, leading/trailing slots.
 * The visible source-of-truth for form copy: every Input on a page
 * should be wrapped in Field so the schema (label/required/error)
 * is structured and screen-reader-correct.
 */
