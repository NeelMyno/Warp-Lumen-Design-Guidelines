      ...
      {PRESETS.map((name) => {
        ...
        return (
          <button
            ...
            className={[
              "text-left px-3 py-[var(--space-1_5)] rounded-[var(--radius-md)] text-label-sm transition-colors duration-[var(--motion-fast)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--lumen-lime-a64)] focus-visible:outline-offset-1",
              isActive
