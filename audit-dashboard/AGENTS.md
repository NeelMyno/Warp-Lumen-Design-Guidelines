...
> [!note]
> This file is the agent contract for the audit-dashboard subdirectory. Read [the root `AGENTS.md`](../AGENTS.md) first — its **19 hard rules** are the system-wide contract. This file adds dashboard-specific operating notes on top.
...
Read in this order: root [`AGENTS.md`](../AGENTS.md) (system contract, 19 hard rules) → this file → [`README.md`](README.md) (human-flavored stack notes) → [`ROUTES.md`](ROUTES.md) (per-route map) → component-level `component.md` files at the repo root.
